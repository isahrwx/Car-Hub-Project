    ...
    <div className='search-manufacturer'>
      <Combobox>
        <div className="relative w-full">
          ...
          <ComboboxInput className="search-manufacturer__input" placeholder='WolksWagen' displayValue={(manufacturer:string)=>manufacturer} onChange={(e)=>setQuery(e.target.value)}/>
